...
def main():
    ...
    ventana_principal.iconbitmap("C:\\Users\\nelso\\OneDrive\\Escritorio\\caprpeta final")
...
if __name__ == "__main__":
    crear_tabla_usuarios()  # Crear la tabla de usuarios si no existe
    ventana_login()  # Inicia el proceso de login
