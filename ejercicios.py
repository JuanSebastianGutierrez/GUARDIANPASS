...
def main():
    ...
    global entry_aplicacion, entry_longitud, entry_contrasena, entry_aplicacion_manual
    entry_aplicacion, entry_longitud, entry_contrasena, entry_aplicacion_manual,  = None, None, None, None
    ...
    def crear_widgets():
        ...
        lbl_aplicacion_manual = ctk.CTkLabel(frame_opciones, text="Aplicación:")
        lbl_aplicacion_manual.grid(row=4, column=0, padx=5, pady=5)
        
        lbl_contrasena = ctk.CTkLabel(frame_opciones, text="Contraseña:")
        lbl_contrasena.grid(row=5, column=0, padx=5, pady=5)

        entry_aplicacion_manual = ctk.CTkEntry(frame_opciones)
        entry_aplicacion_manual.grid(row=5, column=1, padx=5, pady=5)
    ...
    def guardar_contrasena_manual():
        aplicacion = entry_aplicacion_manual.get().strip()
